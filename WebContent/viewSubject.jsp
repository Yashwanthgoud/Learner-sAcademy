...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/SecondPhase_Project'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/SecondPhase_Project//Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<%} else{
response.sendRedirect("/SecondPhase_Project/Dashboard.jsp");
%>
